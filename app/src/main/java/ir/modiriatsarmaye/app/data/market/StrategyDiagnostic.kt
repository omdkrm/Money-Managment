...
data class StrategyDiagnostic(
    ...
    val adjustedPriceRial: Double? = null,
    val closingPriceToman: Double? = null,
    val latestPriceToman: Double? = null,
    val adjustedPriceToman: Double? = null,
    val providerResult: Boolean = false,
    val symbolMappingSuccess: Boolean = false,
    val parsingSuccess: Boolean = false,
